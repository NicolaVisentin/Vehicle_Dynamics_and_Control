...
%                                                                         %
%   Mixed slip-deceleration control (some parameters, in particular       %
%   noise, ABS on/off, and filtering, need to be adjusted in the Simulink %
%   file)                                                                 %
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Kp_high=400;       % proportional gain (for high speeds)
Kp_low=10;         % proportional gain (for low speeds)
%Kp_thresh=70/3.6; % speed threshold for gain scheduling [m/s]

Kd_high=40;        % derivative gain (for high speeds)
Kd_low=30;         % derivative gain (for low speeds)
%Kd_thresh=30/3.6; % speed threshold for gain scheduling [m/s]
